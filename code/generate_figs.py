...
from source_paths import EMBEDDING_CSV, FROZEN_ROOT, IDENTITY_CSV, SUPPLEMENTARY_DIR, find_layer_file

ROOT = FROZEN_ROOT
# Main-text figures land alongside the analysis figures, so supplementary/figures/
# is the single place to look for anything the manuscript cites.
OUTDIR = SUPPLEMENTARY_DIR / "figures"

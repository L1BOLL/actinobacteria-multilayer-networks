...
from data_io import save_figure, FIG_DIR, REPORT_PATH, SEED, TABLE_DIR, ensure_output_dirs, layer_groups, load_tensor
...
def main() -> None:
    ...
    save_figure(fig, "layer_overlap_heatmap", FIG_DIR)
    plt.close(fig)
...
- layer_overlap_heatmap.png  (* = BY-FDR sig biological, (c) = confound)
"""
    replace_section(REPORT_PATH, "<!-- layer_overlap RESULTS -->", "Cross-layer overlap against a degree-preserving null", body)

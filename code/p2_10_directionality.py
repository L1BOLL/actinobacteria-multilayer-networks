#!/usr/bin/env python3
"""P2.10 — Per-layer directional asymmetry + row/column convention anchor."""
...
from data_io import REPORT_PATH, TABLE_DIR, ensure_phase2_dirs, load_tensor
...
def main() -> None:
    ...
    df.to_csv(TABLE_DIR / "p2_10_directionality_audit.csv", index=False)
...
"""
    ...
    replace_section(REPORT_PATH, "<!-- P2.10 RESULTS -->", "P2.10 Direction-convention audit", body)

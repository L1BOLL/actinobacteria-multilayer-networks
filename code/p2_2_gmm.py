...
def main() -> None:
    ...
    bic_df.to_csv(TABLE_DIR / "p2_2_gmm_modelselect.csv", index=False)
    dip_df.to_csv(TABLE_DIR / "p2_2_diptest.csv", index=False)
    best_df.to_csv(TABLE_DIR / "p2_2_summary.csv", index=False)
    if not cluster_df.empty:
        cluster_df.to_csv(TABLE_DIR / "p2_2_cluster_centroids.csv", index=False)
        membership_df.to_csv(TABLE_DIR / "p2_2_cluster_membership.csv", index=False)

#!/usr/bin/env python3
"""P2.7 — Per-layer descriptors. Pairs-based (main) and edges-based reciprocity. Data is binary; layer constants cancel."""
...
def main() -> None:
    ...
    df.to_csv(TABLE_DIR / "p2_7_proximity_sensitivity.csv", index=False)
...
"""
    replace_section(REPORT_PATH, "<!-- P2.7 RESULTS -->", "P2.7 Per-layer connectivity descriptors", body)

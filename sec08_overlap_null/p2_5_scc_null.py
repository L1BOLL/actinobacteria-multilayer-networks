...
def main() -> None:
    ...
    df.to_csv(TABLE_DIR / "p2_5_scc_null.csv", index=False)
    ...
    fig.savefig(FIG_DIR / "p2_5_scc_null.png", dpi=300, bbox_inches="tight")
    plt.close(fig)
...
- p2_5_scc_null.png
"""
    replace_section(REPORT_PATH, "<!-- P2.5 RESULTS -->", "P2.5 SCC null test", body)
